  ...
  return (
    <Card className="w-full max-w-2xl p-6 text-center shadow-lg bg-white space-y-6">
      ...
      <CardContent className="bg-blue-100/70 p-4 rounded-lg border border-blue-200 space-y-4 text-left text-gray-700 leading-relaxed">
        ...
        <p>
          📄 To start, you'll paste in your <strong>resume</strong> and a{" "}
        ...
        <p>
          ✍️ After that, you'll collaborate with the tool to refine and create a new profile statement that better aligns with your goals and self-understanding.
        </p>
        <p>
